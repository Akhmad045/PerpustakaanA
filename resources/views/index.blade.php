                ...
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="auth">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link" href="pages/samples/login.html"> Admin </a>
                                </li>
                                <li class="nav-item"> <a class="nav-link" href="{{ url('basic-table') }}"> User </a>
                                </li>
                                        ...
                                        <div class="tab-pane fade show active" id="overview" role="tabpanel"
                                            ...
                                            <div class="d-flex flex-wrap justify-content-xl-between">
                                                ...
                                                <div
                                                    ...
                                                    <i class="mdi mdi-book mr-3 icon-lg text-primary"></i>
                                                    <div class="d-flex flex-column justify-content-around">
                                                        <small class="mb-1 text-muted">Buku</small>
                                                        <h5 class="mr-2 mb-0">{{$buku_hitung}}</h5>
                                                    </div>
                                                </div>
                                                ...
                                                <div
                                                    ...
                                                    <div class="d-flex flex-column justify-content-around">
                                                        ...
                                                        <h5 class="mr-2 mb-0">{{$kategori_hitung}}</h5>
                                                    </div>
                                                </div>
                                                <div
                                                    class="d-flex border-md-right flex-grow-1 align-items-center justify-content-center p-3 item">
                                                    <i class="mdi mdi-account-box mr-3 icon-lg text-primary"></i>
                                                    <div class="d-flex flex-column justify-content-around">
                                                        <small class="mb-1 text-muted">User</small>
                                                        <h5 class="mr-2 mb-0">{{$user_hitung}}</h5>
                                                    </div>
                                                </div>
                                                <div
                                                    class="d-flex border-md-right flex-grow-1 align-items-center justify-content-center p-3 item">
